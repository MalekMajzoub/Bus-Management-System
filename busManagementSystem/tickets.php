...
<html>
     ...
     <body>
            <?php
                ...
                $sql = "SELECT ticketDOP, ticketPickUPLoc, ticketDropOffLoc, ticketPrice, resTimeFrom, resTimeTo, busID, driverFN, driverLN
                    FROM ONLINETICKET NATURAL JOIN SEAT NATURAL JOIN BUS NATURAL JOIN DRIVES NATURAL JOIN DRIVER
                            WHERE passengerID=$PASSID ORDER BY ticketDOP";
